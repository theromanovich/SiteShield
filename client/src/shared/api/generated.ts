...
export const accountControllerGetAccount = (options?: SecondParameter<typeof createInstance>) => {
  return createInstance<AccoutDto>({ url: `/account`, method: 'GET' }, options);
};
...
export const accountControllerPatchAccount = (
  ...
  return createInstance<AccoutDto>(
    {
      url: `/account`,
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
...
export const blockListControllerRemoveBlockItem = (
  ...
  return createInstance<BlockItemDto>({ url: `/block-list/item/${id}`, method: 'DELETE' }, options);
};
